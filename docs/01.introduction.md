...
A full list of all the supported Pd objects can be found [here](14.Supported_vanilla_objects.md)

A compiled list of unsupported Pd objects can be found [here](15.Unsupported_vanilla_objects.md)
